      ...
      <div class="col-50">
        <div class="container">
          ...
          <hr>
            ...
            <button type="submit" name="order_cart"   class="btn btn-primary ml-4 order_detail " onclick="myFunction()" >Buy Now</button>
            </div>
            </form>
      ...
      <div class="container">
        ...
        <div class="cart_items pt-2 pb-2">
          ...
          ?>
                ...
                <ul class="pl-0 ml-0 ">
                  <li class="list-group-item d-flex justify-content-around lh-condensed">
                    ...
                    <span class="text-muted"><?php echo number_format($row['totalPrice'], 2) ?></span>
                  </li>
                  </li>
                </ul>
          ...
          <?php
            ...
            $order_id = uniqid();
            if($cartTotal > '1'){ 
              $order_query = "INSERT INTO `orders` ( `order_id`, `userId`, `count_items`,`mode_payment`,`order_date`)
              VALUES ( '$order_id', '$userId', '$cart_count','$mode_pay',current_timestamp())  ";
