                ...
                <div class="box-body">
                  <table class="table table-bordered" id="example1">
                    ...
                    <?php
                      ...
                      try{
                        $stmt = "SELECT * FROM orders WHERE userId='$current_user'";
                        ...
                        while($rows= mysqli_fetch_assoc($result)){
                          ...
                          echo "
                            <tr>
                              <td class='hidden'></td>
                              <td>".date('M d, Y', strtotime($rows['order_date']))."</td>
                              <td>".$rows['order_id']."</td>
                              <td>&#36; ".number_format($rows['order_total'], 2)."</td>
                              <td>".$rows['mode_payment']."</td>
                            </tr>
                          ";
                        }
